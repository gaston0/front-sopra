...
const AuthResetPassword = ({ subtext }) => {
    ...
    return (
        <Box component="form" onSubmit={handleReset} mt={2}>
            ...
            <Typography variant="subtitle1" fontWeight={600} component="label" htmlFor='password' mb="5px" >Email</Typography>
            <TextField
                id="email"
                label="Email"
                type="email"
                ...
                mb={2}
            />
            <Typography variant="subtitle1" fontWeight={600} component="label" htmlFor='password' mb="5px" >Old Password</Typography>
            <TextField
                id="oldPassword"
                label="Old Password"
                type="password"
        ...
        >
            ...
            <Box mt={3}> {/* Ajout de l'espace en haut du bouton */}
                {subtext}
            </Box>
        </Box>
    );
